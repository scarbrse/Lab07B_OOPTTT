...
public class OOPTTTFrame extends JFrame
{
    ...
    OOPTTTFrame()
    {
        ...
        errorOption = new JOptionPane("Invalid move");
        ...
        playerOneText.setFont(new Font("Times New Roman", Font.PLAIN, 25));
        ...
        playerTwoText.setFont(new Font("Times New Roman", Font.PLAIN, 25));

        buttonPanel.setLayout(new GridLayout(1,2,10,0));
        buttonPanel.add(newGameButton);
        newGameButton.addActionListener(newGame);
        newGameButton.setFont(new Font("Times New Roman", Font.PLAIN, 25));
